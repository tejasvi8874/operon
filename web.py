...
st.markdown('''
    ...
    <center><i style="color: white;" >Operon Finder will be unavailable on August 9, 2022 from 9am - 11am due to undergoing network maintenance of the PATRIC system.</i></center>
    <br>
    ''', unsafe_allow_html=True)
